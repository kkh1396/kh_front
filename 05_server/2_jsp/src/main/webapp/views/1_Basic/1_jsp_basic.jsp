...
<body>
    ...
    <h3> 1 JSP 스크립트 원소 </h3>
    <p>JSP 페이지에서 자바코드를 기술 할 수 있는 문법(기능)</p>
    ...
    <ol>
        ...
        <li>
            선언문  : &lt;%! %&gt; <br>
            맴버 변수, 메소드를 선언하기 윈한 문법 
        </li>
    </ol>

    <!-- <a href="/2_jsp/views/1_Basic/1_jsp_basic.jsp"></a> -->
    ...
    <ol>
        <li>
             page 지시어 : 현재 jsp페이지를 처리할 때 필요한 속성들을 작성 
         ...
         <li>
            include 지시어 : 현재 jsp 페이지 내에 또 다른 jsp 페이지를 포함시키고자 할 떄 사용
            <br>
             <a href="4_directiveInclude.jsp">view detail</a>
         </li>
         
         <li>
              taglib 지시어 : jsp 기능을 확장시킬 수 있는 추가적인 라이브러리 등록할 떄 사용
