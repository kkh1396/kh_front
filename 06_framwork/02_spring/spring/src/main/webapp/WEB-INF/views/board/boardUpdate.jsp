...
<body>
    ...
    <div class="outer">
        ...
        <div class="inner-area">
            ...
            <form id="updateForm" method="post" action="/board/update" enctype="">
            	<input type="hidden" name="boardNo" value="${ board.boardNo }"/>
                <table align="center" class="table">
                    <tr>
                        <th width="100"><label for="title">${ board.boardTitle }</label></th>
                        <td>
                            <input type="text" name="boardTitle" id="title" class="form-control" value="${ board.boardTitle }" required />
                        </td>
                    </tr>
                    <tr>
                        <th><label for="writer">${ board.boardWriter }</label></th>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="file" name="boardUpfile" id="upfile" class="form-control-file border"><br>
                            첨부 파일 : 
