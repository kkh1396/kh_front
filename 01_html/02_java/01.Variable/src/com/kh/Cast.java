...
public class Cast {
	...
	public static void forceCasting() {
		...
		int result;
		result = (int)d1 + i1;
		// 4.0 (double) + 50(int) => 4.0 (int) + 50(int) = 54.0(int)
		//   => 54.0(double) => 54(int)
		result = (int)(d1 + i1);
		// 4.0 (double) + 50(int) => 4.0 (double) + 50(double) = 54.0(double)
		//   => 54.0(double) => 54(int)
	...
	public static void autoCasting() {
		...
		double d1 = i1; // il(int) -> (double) 로 변경 
						//  12 => 12.0
		...
		double result = i2 + d2 ; // i2 (int) => (double)
								  // 15 => 15.0
								 // i2 + d2 => int + double => double + double = double 
		
		System.out.println(result);    //  i2 + d2 = 18.3(double)
