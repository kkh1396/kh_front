...
//		 if (list.size() == 0) {
	...
	public void searchById(String searchId) {
		...
		//  * 변경 사항 *
		// 1) DAO에게 요청했던 부분을 Service 에게 요청
		// 2) 기능 변경 : 아이디에 해당하는 회원이 아닌
		//				전달된 아이디가 포함된 회원 정보들을 조회
		// 		--> 반환타입이 Member -> ArrayList<Member>로 변경됨!
	 ...
	 *  
	 */
	public void updateMember(String id, String pwd, String gender, String addres, String hobby) {
