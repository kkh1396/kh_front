...
<body>
	...
	<pre>
		- 변수 삭제 : (c:remove var="삭제할 변수명" [scope="삭제하고자하는영역"])
	...
	<p> page scope 에 저장된 temp : ${ temp }</p>
	...
	<pre>
		...
		- 콤마(,)가 아닌 다른 구분자를 사용하고자 할 때
		- Java에서 문자열.split("구분자") 또는 StringTokenizer 와 비슷한 기능	
	</pre>
	
	<%-- movies 라는 변수에 영화를 5개 저장 (구분자: / . ,) --%>
	<c:set var="movies" value="캡틴아메리카/주유소습격사건,아이언맨.고독한미식가/너의이름은"/>
