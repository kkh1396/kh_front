...
public class TestRun {
	 ...
	 * - [Prepared]Statement : 연결된 DB에 SQL문을 전달하여
	 * 실행하고 그 결과를 받아주는 객체
	 * 
	 ...
	 * 	2) Connection 객체
	 * 				생성 : 연결하고자 하는 DB정보를 전달하여 해당 DB와 연결하면서 생성 -> DB정보 : 접속 주소(url),
	 * 					  사용자명(username), 비밀번호(password) 
	...
	public static void insertTest() {
		...
		try {
			...
			// 4,5) SQL문을 실행하고 결과 받기 (=> int)
				String sql = "INSERT INTO TEST VALUES (3,'김규형', SYSDATE)";
