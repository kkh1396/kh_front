...
<body>
	...
	- s3에 담긴 값이 '힘내세요!!!'와 일치하는 가? ${ s3 == '힘내세요!!!' } 또는 ${ s3 == "힘내세요!!!" } <br>
	...
	- list2가 비어있지 않은가 ? ${ not empty list2 }
	<br>
	...
	+ big이 small보다 크고 list1이 비어있는가? <br>
	${ big gt small and empty list1 } 또는 ${ big > small && empty list1 }
</body>
</html>
